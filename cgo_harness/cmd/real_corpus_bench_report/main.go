...
func main() {
	...
	r := buildReport(files, samples, resources, failures, attemptedLanguages)
...
func buildReport(inputs []string, samples []sample, resources []runResource, failures []failureSummary, attemptedLanguages []string) report {
	...
	return report{
		...
		Languages:          buildLanguageReports(summaries, resources, failures, attemptedLanguages),
	}
}
...
func buildLanguageReports(summaries []benchmarkSummary, resources []runResource, failures []failureSummary, attemptedLanguages []string) []languageReport {
...
func writeMarkdown(path string, r report) error {
	...
	fmt.Fprintf(&b, "| Language | Readiness | Full Go | Full C | Full xC | Edit Go | Edit C | Edit xC | No-edit Go | No-edit C | No-edit xC | Max RSS | Quality | Top attribution | Failure |\n")
	fmt.Fprintf(&b, "|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|\n")
