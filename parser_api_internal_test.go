...
func TestEffectiveParseMergePerKeyCap(t *testing.T) {
	...
	if got := effectiveParseMergePerKeyCap(&Language{Name: "go"}, maxStacksPerMergeKey, false); got != 8 {
		t.Fatalf("effectiveParseMergePerKeyCap(go, default, full) = %d, want 8", got)
	}
